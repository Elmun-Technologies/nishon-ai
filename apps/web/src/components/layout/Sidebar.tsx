...
const CATEGORIES: Array<{
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/ad-library', labelKey: 'navigation.adLibrary', fallback: 'Ad Library', icon: ScanSearch },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/creative-hub/brand-kit', labelKey: 'navigation.brandKit', fallback: 'Brand Kit', icon: Palette },
