    ...
    return (
      <div className="space-y-1">
        ...
        <textarea
          ref={ref}
          className={cn(
            'flex w-full rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50 px-3 py-2.5 text-sm text-slate-900 dark:text-slate-50 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-slate-900/20 focus:border-slate-300 dark:border-slate-600 transition-all duration-200 resize-none',
