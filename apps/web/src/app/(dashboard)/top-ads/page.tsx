  ...
  return (
    <div className="space-y-5 max-w-6xl">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-[#111827]">Top Ads</h1>
          <p className="text-[#6B7280] text-sm">See your top performing ads and campaigns by CTR</p>
        </div>
      ...
      <Card padding="none">
        {loading ? (
          ...
          <div className="p-12 text-center space-y-3">
            <p className="text-2xl font-bold text-[#111827]">No landing page data found</p>
            <p className="text-sm text-[#6B7280]">Launch campaigns with landing pages to see your performance data here.</p>
              ...
              <tbody>
                {filtered.map((r) => (
                  <tr key={r.campaignId} className="border-b border-[#F3F4F6]">
                    <td className="px-4 py-3 text-sm text-[#111827]">{r.name}</td>
                    <td className="px-4 py-3 text-sm text-[#6B7280]">{r.status}</td>
