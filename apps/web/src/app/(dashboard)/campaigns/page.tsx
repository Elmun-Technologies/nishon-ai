                  ...
                  <div className="mt-1 bg-[#F9FAFB] border border-[#D1D5DB] border-t-0 rounded-b-xl px-5 py-4">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                      {[
                        ...
                        { label: 'Objective', value: OBJECTIVE_LABELS[campaign.objective] ?? campaign.objective },
                    ...
                    <div className="flex items-center gap-2 pt-3 border-t border-[#E5E7EB]">
                      {campaign.status === 'active' ? (
                        <Button
                          ...
                          onClick={(e) => { e.stopPropagation(); handleStatusChange(campaign.id, 'paused') }}
                        >
                          ⏸ Pause
                        </Button>
                        ...
                        <Button
                          ...
                          size="sm"
                          loading={isThisLoading}
                          onClick={(e) => { e.stopPropagation(); handleStatusChange(campaign.id, 'active') }}
                        >
                          ▶ Resume
                        </Button>
                      ) : null}
