          ...
          <Card padding="none">
            <div
              ...
              className={`
                ...
                ${isDragging
                  ? 'border-[#111827] bg-slate-100 dark:bg-slate-800 cursor-copy'
                  : file
                  ? 'border-slate-200 dark:border-slate-700 cursor-default'
                  : 'border-slate-200 dark:border-slate-700 hover:border-[#111827]/50 hover:bg-slate-50 dark:bg-slate-800/50/50 cursor-pointer'
                }
              `}
            >
              {preview ? (
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-xl px-4 py-3 text-slate-900 dark:text-slate-50 placeholder:text-slate-500 dark:text-slate-400 focus:outline-none focus:border-[#111827] transition-all text-sm"
                />
              </div>
