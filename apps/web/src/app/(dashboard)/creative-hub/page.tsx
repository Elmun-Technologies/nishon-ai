...
function CreativeHubInner() {
  ...
  return (
    <div className="mx-auto max-w-7xl space-y-10 pb-16 pt-2">
          ...
          <div className="flex min-w-0 items-start gap-4">
            ...
            <div className="min-w-0">
              ...
              <h1 className="mt-1 text-3xl font-bold tracking-tight text-text-primary md:text-4xl">
                {t('navigation.creativeHub', 'Creative Hub')}
              </h1>
              <p className="mt-2 max-w-2xl text-body text-text-secondary">{t('creativeHubPage.heroSubtitle', '')}</p>
            </div>
          </div>
      ...
      {/* Workspace — forced dark subtree for existing generators */}
