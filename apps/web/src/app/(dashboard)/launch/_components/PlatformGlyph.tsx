...
export type PlatformVariant = 'meta' | 'google' | 'yandex' | 'telegram'
...
export function platformIconShell(variant: PlatformVariant) {
...
export function PlatformGlyph({ variant }: { variant: PlatformVariant }) {
  switch (variant) {
    case 'meta':
