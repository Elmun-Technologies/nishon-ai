...
export function AIAdCopyGenerator({ onGenerateAdCopy, aiLoading }: AIComponentsProps) {
  ...
  return (
    <Card padding="lg">
      <h3 className="text-lg font-semibold text-text-primary mb-4">AI Ad Copy Generator</h3>
...
export function AIKeywordGenerator({ onGenerateKeywords, aiLoading }: AIComponentsProps) {
  ...
  return (
    <Card padding="lg">
      <h3 className="text-lg font-semibold text-text-primary mb-4">AI Keyword Generator</h3>
      <div className="space-y-4">
        <div>
          <Label>Product Name</Label>
          <Input
...
export function AIBudgetOptimizer({ onGenerateBudgetOptimization, aiLoading }: AIComponentsProps) {
  ...
  return (
    <Card padding="lg">
      <h3 className="text-lg font-semibold text-text-primary mb-4">AI Budget Optimizer</h3>
      <div className="space-y-4">
        <div>
          <Label>Objective</Label>
          <Select
...
export function AIImagePromptGenerator({ onGenerateImagePrompt, aiLoading }: AIComponentsProps) {
  ...
  return (
    <Card padding="lg">
      <h3 className="text-lg font-semibold text-text-primary mb-4">AI Image Prompt Generator</h3>
      <div className="space-y-4">
        <div>
          <Label>Product Name</Label>
          <Input
    ...
    <Card padding="lg">
      ...
      <div className="space-y-4">
        {recommendations.length === 0 ? (
          <p className="text-text-tertiary">No recommendations available yet</p>
        ) : (
          recommendations.map((recommendation, index) => (
            <div key={index} className="border border-border rounded-lg p-4">
              ...
              <div className="text-text-primary">{recommendation.data.text}</div>
