    ...
    <Card padding="lg">
      ...
      {connectionStatus === 'connecting' && (
        <div className="space-y-2 mb-4">
          <Progress value={50} />
          <p className="text-sm text-text-tertiary">Connecting to Meta Ads API...</p>
        </div>
      )}
  ...
  return (
    <Card padding="lg">
      ...
      {connectionStatus === 'connecting' && (
        <div className="space-y-2 mb-4">
          <Progress value={60} />
          <p className="text-sm text-text-tertiary">Connecting to Google Ads API...</p>
        </div>
      )}
  ...
  return (
    <Card padding="lg">
      ...
      {connectionStatus === 'connecting' && (
        <div className="space-y-2 mb-4">
          <Progress value={40} />
          <p className="text-sm text-text-tertiary">Connecting to Yandex Direct API...</p>
        </div>
      )}
  ...
  return (
    <Card padding="lg">
      ...
      {connectionStatus === 'connecting' && (
        <div className="space-y-2 mb-4">
          <Progress value={30} />
          <p className="text-sm text-text-tertiary">Connecting to Telegram Ads...</p>
        </div>
      )}
          ...
          {Object.entries(connections).map(([platform, connected]) => (
            <div key={platform} className="text-center">
              <div className={`text-2xl mb-2 ${
                connected ? 'text-green-400' : 'text-text-tertiary'
              }`}>
                {platform === 'meta' && '📘'}
                {platform === 'google' && '🔍'}
                {platform === 'yandex' && '📘'}
