...
const ITEM_HREFS: Record<string, string> = {
  launchWizard: '/features/launch-wizard',
  campaignManager: '/features/campaign-manager',
  audienceBuilder: '/features/audience-builder',
  retargeting: '/features/retargeting',
  aiDecisions: '/features/ai-decisions',
  autoOptimization: '/features/auto-optimization',
  creativeScorer: '/features/creative-scorer',
  budgetOpt: '/features/budget-optimization',
  simulation: '/features/simulation',
  roiCalculator: '/features/roi-calculator',
  performance: '/features/performance-analytics',
  reporting: '/features/reporting',
  competitorIntel: '/features/competitor-intel',
  automationRules: '/features/automation-rules',
  topAds: '/features/top-ads',
  workspaceTeam: '/features/workspace-team',
  adAccounts: '/features/ad-accounts',
  productsPlans: '/features/products-plans',
  paymentsInvoices: '/features/payments-invoices',
  mcpCreds: '/features/mcp-credentials',
  helpCenter: '/features/help-center',
}
