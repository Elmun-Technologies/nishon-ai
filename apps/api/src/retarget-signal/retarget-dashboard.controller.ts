...
export class RetargetDashboardController {
  ...
  @Post("start")
  @ApiOperation({
    summary: "7 kun kutmasdan retargetni qo‘lda ishga tushirish",
  })
  ...
  @ApiOperation({
    summary:
      "Mapping + Meta: Custom Audience, Campaign, AdSet, Creative, Ad (bir bosish)",
    description:
  ...
  @ApiOperation({
    ...
    description:
      "Avval bot orqali /start phone=998… — Redis da chat_id bo‘lishi kerak.",
  })
