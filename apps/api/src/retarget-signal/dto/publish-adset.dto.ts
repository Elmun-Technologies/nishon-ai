...
export class PublishAdsetDto {
  ...
  @ApiPropertyOptional({
    description: "Kunlik byudjet (akkaunt valyutasi, Meta talabiga mos)",
  })
  @IsOptional()
  @Type(() => Number)
  @IsNumber()
  ...
  @ApiPropertyOptional({
    description: "Meta dan keyin Telegram xabar yuborish (default: true)",
  })
  @IsOptional()
  @Transform(({ value }) =>
  ...
  @ApiPropertyOptional({
    description: "Tugma URL — default RETARGET_TELEGRAM_SHOP_URL",
  })
  @IsOptional()
  @IsString()
