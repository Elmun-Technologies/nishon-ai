...
export class ConversionToLeadSyncService {
  ...
  async syncConversionToLead(
    ...
    try {
      ...
      const leadPayload = this.transformConversionToLead(
        conversion,
        fieldMappings,
      );
  ...
  async syncConversionsToLeads(
    ...
    try {
      ...
      for (const conversion of conversions) {
        try {
          const lead = this.transformConversionToLead(
            conversion,
            fieldMappings,
          );
          leads.push(lead);
  ...
  private transformConversionToLead(
    ...
    if (campaignMapping) {
      addCustomField(
        parseInt(campaignMapping.crmField),
