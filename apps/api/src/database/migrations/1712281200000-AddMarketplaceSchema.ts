...
export class AddMarketplaceSchema1712281200000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
      ...
      new Table({
        ...
        columns: [
          ...
          { name: "description", type: "text", isNullable: true },
          {
            name: "issuer",
            type: "varchar",
            comment: "Google, Meta, Yandex, etc",
          },
      ...
      new Table({
        ...
        columns: [
          ...
          { name: "duration_months", type: "integer", isNullable: true },
          {
            ...
            type: "jsonb",
            isNullable: true,
            comment: "{roas: 4.2, cpa: 12.5, conversions: 100}",
          },
    ...
    await queryRunner.createIndex(
      "agent_case_studies",
      new TableIndex({ columnNames: ["agent_profile_id"] }),
    );
    await queryRunner.createIndex(
      "agent_case_studies",
      new TableIndex({ columnNames: ["is_public", "is_verified"] }),
    );
      ...
      new Table({
        ...
        columns: [
          ...
          { name: "agent_profile_id", type: "uuid" },
          {
            name: "platform",
            type: "varchar",
            comment: "meta, google, yandex, tiktok",
          },
          {
            name: "aggregation_period",
            type: "date",
            comment: "YYYY-MM-01 for monthly",
          },
          {
            name: "total_spend",
            type: "decimal",
    ...
    await queryRunner.createIndex(
      "agent_platform_metrics",
      new TableIndex({ columnNames: ["synced_at"] }),
    );
