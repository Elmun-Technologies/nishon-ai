...
export class AiAgentController {
  ...
  @ApiOperation({
    ...
    description: 'Calls GPT-4o with business data and returns complete strategy with budget allocation and KPI forecasts. Takes 8-15 seconds.',
  })
  ...
  @HttpCode(HttpStatus.OK)
  @ApiOperation({
    summary: 'Run optimization loop — AI analyzes campaigns and creates decisions',
    description: 'Normally runs automatically every 2 hours. Call this to trigger manually.',
  })
