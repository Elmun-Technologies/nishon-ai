...
export class AiDecision {
  ...
  @Column({ type: 'enum', enum: AiDecisionAction })
  ...
  @ManyToOne(() => Workspace, (workspace) => workspace.aiDecisions, { onDelete: 'CASCADE' })
  ...
  @ManyToOne(() => Campaign, (campaign) => campaign.aiDecisions, { nullable: true, onDelete: 'SET NULL' })
