...
describe("FraudDetectionService", () => {
  ...
  beforeEach(async () => {
    ...
    agentProfileRepo = module.get<Repository<AgentProfile>>(
  ...
  describe("verify", () => {
    ...
    it("should handle errors gracefully", async () => {
      ...
      jest
        .spyOn(metricsRepo, "findOne")
        .mockRejectedValue(new Error("DB Error"));
      jest
        .spyOn(syncLogRepo, "findOne")
        .mockRejectedValue(new Error("DB Error"));
